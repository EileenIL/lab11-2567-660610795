...
export default function RegisterForm() {
  ...
  const allChecksOnClick = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox"  onChange={allChecksOnClick} checked= {allChecks} /> I agree to the terms and
        conditions
      </div>
